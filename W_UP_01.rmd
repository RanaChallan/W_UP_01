...
ggplot(data = mydata, aes(x = pushups, y = position)) +
  ...
  coord_flip() + 
  theme(plot.title = element_text(size = 18, hjust = 0.5))  # Adjust title size and center it
```
...
Also, by using the Numerical-Cat helper tool, I was able to perform a T Test and a Summary of the data (favstats).
